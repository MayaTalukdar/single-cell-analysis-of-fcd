...
#     collapsed_10X_UMI_genotype_results <- read.table(paste0("/n/groups/walsh/indData/Maya/FCD_project/analysis/2_Analyze_Full_Object/Output/Genotyping/", current_sample, "/", "scMosaicHunter_results_", current_sample, "_using_collapsed_10X_umi_with_custom_VAF_looseGenotyping_just_relevant_cols.txt"), header = TRUE)
...
# saveRDS(seurat_obj, "/n/groups/walsh/indData/Maya/FCD_project/analysis/2_Analyze_Full_Object/Output/Seurat_Objects/9_processed_seurat_obj_integrated_azimuthAnnotations_ourAnnotations_doubletsFiltered_FCD1Filtered_looseGenotyping.RDS")
# saveRDS(seurat_obj@meta.data, "/n/groups/walsh/indData/Maya/FCD_project/analysis/2_Analyze_Full_Object/Output/Seurat_Objects/9_processed_seurat_obj_integrated_azimuthAnnotations_ourAnnotations_doubletsFiltered_FCD1Filtered_looseGenotyping_metadata.RDS")
...
pik3ca_umap_by_expression <- FeaturePlot_scCustom(pik3ca_seurat_obj, reduction = "umap.harmony", features = "PIK3CA") + NoLegend() + ggtitle("PIK3CA Mut: PIK3CA Expression")
pik3ca_umap_by_expression_with_legend <- FeaturePlot_scCustom(pik3ca_seurat_obj, reduction = "umap.harmony", features = "PIK3CA") + ggtitle("PIK3CA Mut: PIK3CA Expression")
...
#UMAP OF GENOTYPING
######################
umap_by_genotyping <- DimPlot(seurat_obj, reduction = "umap.harmony", group.by = "genotype", cols = c("red", "lightgray", "#097969")) + ggtitle("Genotyping")  + NoLegend()
...
######################
#BARPLOT OF PROPORTION OF MUTANT CELLS
######################
...
pval_list <- pval_list[cell_types_to_keep]

write.table(pval_list %>% as.data.frame() %>% t() %>% as.data.frame(), "/n/groups/walsh/indData/Maya/FCD_project/analysis/2_Analyze_Full_Object/Figures/genotyping_figure_loose/pval_list.txt", sep = "\t", row.names = TRUE, col.names = TRUE)
...
pdf("/n/groups/walsh/indData/Maya/FCD_project/analysis/2_Analyze_Full_Object/Figures/genotyping_figure_loose/pie_chart.pdf", width = 6, height = 6)
colnames(pie_df) <- c("l1", "prop")
...
#FINAL PLOTS
######################
pdf("/n/groups/walsh/indData/Maya/FCD_project/analysis/2_Analyze_Full_Object/Figures/genotyping_figure_loose/genotyping_figure_loose.pdf", width = 5, height =18)
print(wrap_plots(umap_by_type, pik3ca_umap_by_expression, mtor_umap_by_expression, umap_by_genotyping, barplot, barplot_mutProp, ncol = 1))
dev.off()
...
pdf("/n/groups/walsh/indData/Maya/FCD_project/analysis/2_Analyze_Full_Object/Figures/genotyping_figure_loose/pik3ca_genotyping_eff_modeling.pdf", width = 10, height =4)
...
pdf("/n/groups/walsh/indData/Maya/FCD_project/analysis/2_Analyze_Full_Object/Figures/genotyping_figure_loose/mtor_genotyping_eff_modeling.pdf", width = 10, height =4)
